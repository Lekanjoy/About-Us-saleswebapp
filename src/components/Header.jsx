...
const Header = () => {
  ...
  return (
    <header className="relative flex w-full cursor-pointer h-[110px] px-6 justify-between items-center md:border-b md:border-[#D1E9FF] md:px-[120px] md:gap-x-[139px]">
      ...
      <img className=" md:hidden" onClick={handleMobileMenu} src={hamburger} alt="hamburger menu" />
      {/* Mobile Nav */}
     {mobileMenu && <nav className="flex-col gap-y-[26px] pt-8 w-[150px] h-[240px] rounded absolute top-[70px] z-10 bg-white right-1 items-center border border-[#98A2B3] md:hidden md:gap-x-20">
