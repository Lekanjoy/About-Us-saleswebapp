  ...
  return (
    <footer className="bg-[#D1E9FF] flex justify-between flex-col px-6 md:flex-row md:pb-20 md:px-[120px] md:h-[510px]">
      ...
      <div className="hidden flex-col text-[#344054] md:flex md:mt-[111px] md:gap-6">
        <h6 className="text-[18px] font-semibold md:text-[28px] md:font-medium ">About Us</h6>
      ...
      <div className="hidden flex-col text-[#344054] md:flex md:mt-[111px] md:gap-6">
        <h6 className="text-[18px] font-semibold md:text-[28px] md:font-medium ">Resources</h6>
      ...
      <div className="hidden flex-col text-[#344054] md:flex md:mt-[111px] md:gap-6">
        <h6 className="text-[18px] font-semibold md:text-[28px] md:font-medium ">Product</h6>
      ...
      <div className="md:hidden"><SubFooter/></div>
    </footer>
  );
};
